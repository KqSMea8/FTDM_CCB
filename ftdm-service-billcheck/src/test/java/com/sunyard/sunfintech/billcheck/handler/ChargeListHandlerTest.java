...
public class ChargeListHandlerTest {
    ...
    @Test
    public void test(){
        QueryListHandler handler = new QueryListHandler(1,200032,new ClearModel("1",null,null), AccountListNode.class);
        ...
        QueryListHandler handler1 = new QueryListHandler(1,200000, new ClearModel("1",null,null),AccountListNode.class);
        //System.out.println(handler.getHandDatas().size());
        ...
        QueryListHandler handler2 = new QueryListHandler(1,2,new ClearModel("1",null,null),AccountListNode.class);
        //System.out.println(handler.getHandDatas().size());
