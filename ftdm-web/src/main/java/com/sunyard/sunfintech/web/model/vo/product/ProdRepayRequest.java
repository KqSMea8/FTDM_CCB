 ...
 */
public class ProdRepayRequest extends BaseRequest {
    /**
     * 标的编号
     */
    @NotBlank
    ...
    public void setFunddata(String funddata) {
        ...
        setCustRepay(JSON.parseArray(funddata,CustRepay.class));
    }

    public List<CustRepay> getCustRepay() {
        return custRepayList;
    }

    public void setCustRepay(List<CustRepay> custRepayList) {
