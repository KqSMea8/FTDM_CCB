...
import com.sunyard.sunfintech.user.model.bo.BatchAuthenticationResponseSuccessDetail;
 ...
 * 
 */
public class BatchAuthenticationResponse extends BaseResponse {
	...
	public void setSuccess_data(String success_data) {
		...
		if(StringUtils.isNoneBlank(success_data)) {
			this.success_data_detail = JSON.parseArray(success_data,BatchAuthenticationResponseSuccessDetail.class);
		}
	}
