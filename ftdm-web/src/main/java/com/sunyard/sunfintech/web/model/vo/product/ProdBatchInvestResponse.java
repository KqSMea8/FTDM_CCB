 ...
 */
public class ProdBatchInvestResponse extends BaseResponse {
    ...
    @JSONField(serialize=false)
    private List<ProdInvestSuccessData> success_data_obj;
    ...
    public List<ProdInvestSuccessData> getSuccess_data_obj() {
        return success_data_obj;
    }

    public void setSuccess_data_obj(List<ProdInvestSuccessData> success_data_obj) {
