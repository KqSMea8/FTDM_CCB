...
import com.sunyard.sunfintech.user.model.bo.BatchRegisterResponseSuccessData;
 ...
 * 
 */
public class BatchRegisterResponse extends BaseResponse {
	...
	//JsonArray成功信息（有处理成功的数据时，则为必填参数；其中detail_no、mobile、platcust为必填信息）
	...
	public void setSuccess_data(String success_data) {
		...
		if(Strings.isBlank(success_data)){
			this.success_data_detail = JSON.parseArray(success_data, BatchRegisterResponseSuccessData.class);
		}
	}
