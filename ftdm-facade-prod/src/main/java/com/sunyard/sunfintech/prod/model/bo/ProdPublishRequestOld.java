 ...
 * 2017年4月18日
 */
public class ProdPublishRequestOld extends BaseRequest {
	...
	public ProdPublishRequest getProdPublishRequest() {
		ProdPublishRequest prodPublishRequest = new ProdPublishRequest();
		BeanUtils.copyProperties(this, prodPublishRequest);

		return prodPublishRequest;
	}
	/*
	 * 代偿账户列表
	 */
