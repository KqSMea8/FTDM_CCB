 ...
 * 
 */
public class ProductInvestmentDetailResponse extends BaseResponse {
	...
	@JSONField(serialize = false)
	private List<ProductInvestmentDetailResponseDetail> data_detail;
	...
	public List<ProductInvestmentDetailResponseDetail> getData_detail() {
		return data_detail;
	}
	public void setData_detail(List<ProductInvestmentDetailResponseDetail> data_detail) {
