...
public class ProdnonAuthTransferRequestDataBo implements Serializable{
    ...
    public boolean equals(Object o) {
        ...
        ProdnonAuthTransferRequestDataBo that = (ProdnonAuthTransferRequestDataBo) o;
        ...
        if (origin_order_no != null ? !origin_order_no.equals(that.origin_order_no) : that.origin_order_no != null) return false;
        ...
        if (commissionObj != null ? !commissionObj.equals(that.commissionObj) : that.commissionObj != null)
            return false;
        if (commission_ext != null ? !commission_ext.equals(that.commission_ext) : that.commission_ext != null)
            return false;
        if (commission_extObj != null ? !commission_extObj.equals(that.commission_extObj) : that.commission_extObj != null)
            return false;
