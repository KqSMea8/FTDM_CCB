...
public class PropertiesUtil {
    ...
    static{
        InputStream is = PropertiesUtil.class.getClassLoader().getResourceAsStream("config/thirdparty.properties");
        try {
        	props.load(is);
        } catch (IOException e) {
...
//    }
    public static void main(String[] args) throws Exception {
		System.out.println(getAllVal().get("beipay_url"));
		System.err.println(getVal("beipay_url"));
	}
}
