...
public class SysParameterService extends BaseServiceSimple implements ISysParameterService{
    ...
    public String querySysParameter(String key){
        return this.querySysParameter( key);
    }
