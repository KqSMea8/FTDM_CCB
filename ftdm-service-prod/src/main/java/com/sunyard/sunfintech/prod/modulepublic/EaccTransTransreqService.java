...
import com.sunyard.sunfintech.custdao.mapper.CustEaccTransTransreqMapper;
...
public class EaccTransTransreqService implements IEaccTransTransreqService {
    ...
    @Autowired
    private CustEaccTransTransreqMapper custEaccTransTransreqMapper;
    ...
    public boolean addFlow(EaccTransTransreqWithBLOBs eaccTransTransreq) throws BusinessException {
        ...
        custEaccTransTransreqMapper.insertReplace(eaccTransTransreq);
        return true;
    }
