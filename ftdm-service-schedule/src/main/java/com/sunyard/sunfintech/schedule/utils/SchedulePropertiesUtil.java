...
package com.sunyard.sunfintech.schedule.utils;
...
public class SchedulePropertiesUtil {

    private static Logger logger = LoggerFactory.getLogger(SchedulePropertiesUtil.class);
    private static  Properties props = new Properties();;

    private SchedulePropertiesUtil() {}

    static{
        InputStream is = SchedulePropertiesUtil.class.getClassLoader().getResourceAsStream("config/schedule.properties");
        try {
        	props.load(is);
        } catch (IOException e) {
