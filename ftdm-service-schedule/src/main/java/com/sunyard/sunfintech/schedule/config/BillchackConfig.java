 ...
 */
@Component
public class BillchackConfig implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        String baseTaskTypeName = "billcheck";
        try {
        ...
        baseTaskType.setPermitRunStartTime("0 0 0 * * ?");//调度任务开始时间
//        baseTaskType.setPermitRunEndTime("0 30 17 * * ?");//调度任务结束时间
...
//        baseTaskType.setSleepTimeInterval(60 * 1000);//每处理完一批数据后休眠时间
        ...
        baseTaskType.setDealBeanName("billcheckBean");
