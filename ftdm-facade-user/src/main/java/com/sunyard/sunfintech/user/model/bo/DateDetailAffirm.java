 ...
 */
public class DateDetailAffirm implements Serializable {
    ...
    public void setDetail_no(String detail_no) {this.detail_no = detail_no;}

    public String getOrigin_order_no() {return origin_order_no;}
    public void setOrigin_order_no(String origin_order_no) {this.origin_order_no = origin_order_no;}
