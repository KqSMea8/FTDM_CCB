...
public class ProdCompensationRepay implements Serializable {
    /**
     * 
     */
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        ProdCompensationRepay other = (ProdCompensationRepay) that;
