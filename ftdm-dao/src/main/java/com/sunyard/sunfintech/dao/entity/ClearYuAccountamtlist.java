...
public class ClearYuAccountamtlist implements Serializable {
    /**
     * 
     */
    private Long id;
    ...
    /**
     * 总清算金额（必定小于amt）
     * @return switch_amt 总清算金额（必定小于amt）
     */
    ...
    /**
     * 总清算金额（必定小于amt）
     * @param switch_amt 总清算金额（必定小于amt）
     */
    ...
    public boolean equals(Object that) {
        ...
        ClearYuAccountamtlist other = (ClearYuAccountamtlist) that;
