...
public class ClearYuAccount implements Serializable {
    /**
     * 
     */
    private Long id;
     ...
     * 清算金额账户
     */
    private BigDecimal cur_n_balance;

    /**
     * 
     */
    private BigDecimal cur_f_balance;
    ...
    public boolean equals(Object that) {
        ...
        ClearYuAccount other = (ClearYuAccount) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getCur_n_balance() == null ? other.getCur_n_balance() == null : this.getCur_n_balance().equals(other.getCur_n_balance()))
            && (this.getCur_f_balance() == null ? other.getCur_f_balance() == null : this.getCur_f_balance().equals(other.getCur_f_balance()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCur_n_balance() == null) ? 0 : getCur_n_balance().hashCode());
        result = prime * result + ((getCur_f_balance() == null) ? 0 : getCur_f_balance().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", cur_n_balance=").append(cur_n_balance);
        sb.append(", cur_f_balance=").append(cur_f_balance);
