...
public class UnRegisterUserInfo implements Serializable {
    /**
     * 
     */
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        UnRegisterUserInfo other = (UnRegisterUserInfo) that;
