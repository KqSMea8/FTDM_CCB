...
-- 导出 sun_ftdm 的数据库结构
DROP DATABASE IF EXISTS `sun_ftdm`;
CREATE DATABASE IF NOT EXISTS `sun_ftdm` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `sun_ftdm`;

-- 导出  表 sun_ftdm.sys_dept 结构
...
-- 正在导出表  sun_ftdm.sys_dept 的数据：~1 rows (大约)
...
INSERT INTO `sys_dept` (`id_`, `unit_id`, `dept_name`, `parent_id`, `sort_no`, `leaf_`, `enable_`, `remark_`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES
	(1, 1, 'sun_ftdm', 0, 1, 0, 1, 'qw', 1, '2016-06-28 18:04:06', 1, '2016-06-28 18:04:06'),
...
-- 正在导出表  sun_ftdm.sys_dic 的数据：~43 rows (大约)
...
-- 正在导出表  sun_ftdm.sys_email 的数据：~1 rows (大约)
...
-- 导出  表 sun_ftdm.sys_email_config 结构
...
-- 正在导出表  sun_ftdm.sys_email_config 的数据：~1 rows (大约)
...
INSERT INTO `sys_email_config` (`id_`, `smtp_host`, `smtp_port`, `send_method`, `sender_name`, `sender_account`, `sender_password`, `remark_`, `enable_`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES
	(828157583909109760, 'smtp.163.com', '101', '0', 'sun_ftdm', 'sun_ftdm@163.com', 'BK5sgjz5JOOsFuD4w0mbe7==', NULL, 1, 1, '2017-02-05 16:25:29', 1, '2017-02-05 16:37:50');
/*!40000 ALTER TABLE `sys_email_config` ENABLE KEYS */;

-- 导出  表 sun_ftdm.sys_email_template 结构
...
-- 正在导出表  sun_ftdm.sys_news 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `sys_news` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_news` ENABLE KEYS */;

-- 导出  表 sun_ftdm.sys_notice 结构
...
-- 正在导出表  sun_ftdm.sys_notice 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `sys_notice` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_notice` ENABLE KEYS */;

-- 导出  表 sun_ftdm.sys_param 结构
...
-- 正在导出表  sun_ftdm.sys_param 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `sys_param` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_param` ENABLE KEYS */;

-- 导出  表 sun_ftdm.sys_role 结构
...
-- 正在导出表  sun_ftdm.sys_role 的数据：~0 rows (大约)
...
-- 导出  表 sun_ftdm.sys_role_menu 结构
...
-- 正在导出表  sun_ftdm.sys_unit 的数据：~0 rows (大约)
...
INSERT INTO `sys_unit` (`id_`, `unit_name`, `principal_`, `phone_`, `address_`, `sort_`, `enable_`, `remark_`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES
	(1, 'sun_ftdm', '经理', '13945678911', '中国', 1, NULL, NULL, '2017-01-12 00:00:00', 1, '2017-01-28 23:51:57', 1);
/*!40000 ALTER TABLE `sys_unit` ENABLE KEYS */;

-- 导出  表 sun_ftdm.sys_user 结构
...
CREATE TABLE IF NOT EXISTS `sys_user` (
  ...
  `birth_day` data DEFAULT NULL COMMENT '出生日期',
...
-- 正在导出表  sun_ftdm.sys_user 的数据：~2 rows (大约)
...
-- 导出  表 sun_ftdm.sys_user_menu 结构
...
-- 正在导出表  sun_ftdm.sys_user_role 的数据：~0 rows (大约)
...
-- 导出  表 sun_ftdm.sys_user_thirdparty 结构
